...
namespace Aptos.Unity.Sample.UI
{
    public class AptosUILink : MonoBehaviour
    {
        ...
        public TMP_Text playGameButtonText;
        ...
        public void PlayGame()
        {
            ...
            if (AccountBalance < 0.1f)
            {
                ...
                playGameButtonText.text = "Get more APT!";
            }
            else {
                UserDataManager.Instance.SetUser12Words(PlayerPrefs.GetString(AptosUILink.Instance.mnemonicsKey));
